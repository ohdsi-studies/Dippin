...
OhdsiRTools::checkUsagePackage("DippinClopidogrel")
OhdsiRTools::updateCopyrightYearFolder()

# Create manual -----------------------------------------------------------
shell("rm extras/DippinClopidogrel.pdf")
shell("R CMD Rd2pdf ./ --output=extras/DippinClopidogrel.pdf")
...
OhdsiRTools::insertEnvironmentSnapshotInPackage("DippinClopidogrel")
