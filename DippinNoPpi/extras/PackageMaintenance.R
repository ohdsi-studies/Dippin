...
OhdsiRTools::checkUsagePackage("DippinNoPpi")
OhdsiRTools::updateCopyrightYearFolder()

# Create manual -----------------------------------------------------------
shell("rm extras/DippinNoPpi.pdf")
shell("R CMD Rd2pdf ./ --output=extras/DippinNoPpi.pdf")
...
OhdsiRTools::insertEnvironmentSnapshotInPackage("DippinNoPpi")
