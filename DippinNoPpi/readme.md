...
2. In `R`, use the following `devtools` command to install the DippinNoPpi package:
...
License
=======
The DippinNoPpi package is licensed under Apache License 2.0

Development
===========
DippinNoPpi was developed in ATLAS and R Studio.
